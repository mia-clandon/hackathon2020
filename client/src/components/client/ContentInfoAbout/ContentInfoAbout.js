                    ...
                    <div className="col s12 m9">
                        <div className="card white darken-1">
                            <div className="card-content black-text inner_card">
                                ...
                                <p>Копирайтинг обладает огромной информационно-рекламной ценностью, ведь пишутся тексты не для заполнения пустого места, а для взаимодействия с целевой аудиторией. И чем полезнее такие тексты и проще для восприятия, тем они эффективнее.</p>
                            </div>
                        </div>
                    </div>
                </div>
